...
<!--头部-->
    <header class="publicHeader">
        ...
        <div class="publicHeaderR">
            <p><span>下午好！</span><span style="color: #fff21b"> ${userSession.userName }${sessionScope.user.userName}</span> , 欢迎你！</p>
         ...
         <nav>
             <ul class="list">
              <%--<li ><a href="${pageContext.request.contextPath }/jsp/bill.do?method=query">订单管理</a></li>--%>
                  <li ><a href="${pageContext.request.contextPath }/listBill.action">订单管理</a></li>
