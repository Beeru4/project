...
function deleteBill(obj){
	$.ajax({
		...
		url:path+"/bill/deleteBill.action",
...
$(function(){
	$(".viewBill").on("click",function(){
		...
		var obj = $(this);
		///jsp/bill.do?method=view&billid="+ obj.attr("billid");
		window.location.href=path+"/bill/viewBill.action?billid="+ obj.attr("billid");
	});
	
	$(".modifyBill").on("click",function(){
		var obj = $(this);
		// /jsp/bill.do?method=modify&billid="+ obj.attr("billid");
		window.location.href=path+"/bill/viewBill.action?modify=1&billid="+ obj.attr("billid");
	});
	$('#no').click(function () {
		cancleBtn();
	});
