...
function deleteUser(obj) {
    $.ajax({
        ...
        url: path + "/userMgr/delUser.action",
...
$(function () {
    ...
    $(".viewUser").on("click", function () {
        ...
        window.location.href = path + "/userMgr/viewUser.action?uid=" + obj.attr("userid");
    });

    $(".modifyUser").on("click", function () {
        var obj = $(this);
        /*/jsp/user.do?method=modify&uid=*/
        window.location.href = path + "/userMgr/modifyBeforeUser.action?uid=" + obj.attr("userid");
    });
