...
<%@include file="/jsp/common/head.jsp"%>
        <div class="right">
            ...
            <div class="search">
				<%-- ${pageContext.request.contextPath }/jsp/user.do --%>
           		<form method="get" action="${pageContext.request.contextPath }/userMgr/listUser.action">
					<input name="method" value="query" class="input-text" type="hidden">
					 <span>用户名：</span>
					 <input name="queryname" class="input-text"	type="text" value="${queryUserName }${queryname}">
