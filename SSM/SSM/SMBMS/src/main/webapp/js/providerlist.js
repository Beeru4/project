...
$(function(){
	$(".viewProvider").on("click",function(){
		...
		window.location.href=path+"/prov/viewProv.action?proid="+ obj.attr("proid");
	});
	
	$(".modifyProvider").on("click",function(){
		var obj = $(this);
		/*window.location.href=path+"/jsp/provider.do?method=modify&proid="+ obj.attr("proid");*/
		window.location.href=path+"/prov/viewBeforeProv.action?proid="+ obj.attr("proid");
	});
