        ...
        <div class="x_panel">
            <div class="x_title">
                <h2>
                    ...
                    <small>${sessionScope.devUser.devName }
                    ...
                    <ul>
                        ...
                        <li>
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select name="stautsId" class="form-control">
                                        <c:if test="${statusList != null }">
                                            <option value="0">--请选择--</option>
                                            <c:forEach var="dataDictionary" items="${statusList}">
                                                <option
                                                        <c:if test="${dataDictionary.stautsId == stautsId }">selected="selected"</c:if>
                                                        value="${dataDictionary.stautsId}">${dataDictionary.stauts}</option>
                                            </c:forEach>
                                        </c:if>
                                    </select>
                                </div>
                                    ...
                                    <select name="flatformid" class="form-control">
                                        <c:if test="${flatFormList != null }">
                                            ...
                                            <c:forEach var="dataDictionary" items="${flatFormList}">
                                                <option
                                                        <c:if test="${dataDictionary.flatformid == flatformid }">selected="selected"</c:if>
                                                        value="${dataDictionary.flatformid}">${dataDictionary.flatform}</option>
                                            </c:forEach>
                                        </c:if>
                                    </select>
                                </div>
                        ...
                        <li>
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select id="queryCategoryLevel1" name="level1Id" class="form-control">
                                        <c:if test="${categoryLevel1List != null }">
                                            <option value="">--请选择--</option>
                                            <c:forEach var="appCategory" items="${categoryLevel1List}">
                                                <option
                                                        <c:if test="${appCategory.id == level1Id }">selected="selected"</c:if>
                        ...
                        <li>
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <select name="level2Id" id="queryCategoryLevel2" class="form-control">
                                        <c:if test="${categoryLevel2List != null }">
                                            <option value="">--请选择--</option>
                                            <c:forEach var="appCategory" items="${categoryLevel2List}">
                                                <option
                                                        <c:if test="${appCategory.id == level2Id }">selected="selected"</c:if>
                                                        value="${appCategory.id}">${appCategory.categoryName}</option>
                                            </c:forEach>
                                        </c:if>
                                    </select>
                        ...
                        <li>
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select name="level3Id" id="queryCategoryLevel3" class="form-control">
                                        <c:if test="${categoryLevel3List != null }">
                                            <option value="">--请选择--</option>
                                            <c:forEach var="appCategory" items="${categoryLevel3List}">
                                                <option
                                                        <c:if test="${appCategory.id == level3Id }">selected="selected"</c:if>
                                                        value="${appCategory.id}">${appCategory.categoryName}</option>
                                            </c:forEach>
                                        </c:if>
                                    </select>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <table id="datatable-responsive"
                                ...
                                <tbody>
                                <c:forEach var="appInfo" items="${pages.pages }" varStatus="status">
                                    <tr role="row" class="odd">
                                        <td tabindex="0" class="sorting_1">${appInfo.softwareName}</td>
                                        <td>${appInfo.apkName }</td>
                                        <td>${appInfo.softwareSize }</td>
                                        <td>${appInfo.flatform }</td>
                                        <td>${appInfo.level1Name } -> ${appInfo.level2Name }
                                            -> ${appInfo.level3Name }</td>
                                        <td><span id="appInfoStatus${appInfo.id}">${appInfo.stauts }</span></td>
                                        ...
                                        <td>
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li>
                                                        <c:choose>
                                                            <c:when test="${appInfo.stautsId == 2 || appInfo.stautsId == 5}">
                                                            ...
                                                            <c:when test="${appInfo.stautsId == 4}">
                                                    ...
                                                    <li><a class="modifyVersion"
                                                           ...
                                                           status="${appInfo.stautsId }"
                                                           statusname="${appInfo.stauts }"
                                                           data-toggle="tooltip" data-placement="top" title=""
                                                           data-original-title="修改APP最新版本信息">修改版本</a>
                                                    </li>
                                                    <li><a class="modifyAppInfo"
                                                           appinfoid="${appInfo.id }" status="${appInfo.stautsId }"
                                                           statusname="${appInfo.stauts }"
                                                           data-toggle="tooltip" data-placement="top" title=""
                    ...
                    <div class="row">
                        <div class="col-sm-5">
                            <div class="dataTables_info" id="datatable-responsive_info"
                                ...
                                ${pages.currPageNo }/${pages.totalPage }页
                            </div>
                        </div>
                        <div class="col-sm-7">
                            <div class="dataTables_paginate paging_simple_numbers"
                                ...
                                <ul class="pagination">
                                    ...
                                    <c:if test="${pages.currPageNo < pages.totalPage }">
                                        <li class="paginate_button "><a
                                                href="javascript:page_nav(document.forms[0],${pages.currPageNo+1 });"
                                                aria-controls="datatable-responsive" data-dt-idx="1"
                                                tabindex="0">下一页</a>
