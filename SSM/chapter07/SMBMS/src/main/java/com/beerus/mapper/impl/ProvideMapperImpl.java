 ...
 * @Date 2019/4/19
 **/
/*使用继承SqlSessionDaoSupport*/
public class ProvideMapperImpl extends SqlSessionDaoSupport implements ProvideMapper {
    ...
    public List<Provider> list_FindProvAll() throws Exception {
        ...
        return null;*/
        return this.getSqlSession().getMapper(ProvideMapper.class).list_FindProvAll();
    }
