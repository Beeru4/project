...
<%@include file="/jsp/common/head.jsp"%>
    <div class="right">
        ...
        <form id="userForm" name="userForm" method="post" action="${pageContext.request.contextPath }/userMgr/modifyUser.action">
			...
			<input type="hidden" name="user.id" value="${user.id }"/>
			 ...
			 <div>
                    ...
                    <input type="text" Class="Wdate" id="birthday" name="user.birthday" value="${user.birthday }"
